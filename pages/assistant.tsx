...
const configuration = new Configuration({
  apiKey: 'sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', // Replace with your actual OpenAI API key
});
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {!hasConversationStarted && (
          <div className="text-center mb-4">
            ...
            <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-[#4895ef] to-[#c77dff] backdrop-blur-md">
              Ask your career questions and get instant responses!
            </h2>
